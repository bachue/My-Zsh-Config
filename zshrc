...
plugins=(absolute autojump battery brew cargo colored-man-pages colorize docker go go_env httpie jenv kubectl rbenv-installer jsontools osx rake rake-fast rbenv redis-cli rsync ruby-functions rust vundle zsh-syntax-highlighting)
