...
plugins=(absolute autojump battery brew brew-cask colored-man colorize copydir cp docker dnsmasq encode64 extract git-pickaxe go go_env install-linux-manpages rbenv-installer jsontools mongodb dockerport osx pry rails rake rake-fast rbenv redis-cli rsync ruby ruby-functions sbcl sshtunnel sublime thor urltools vundle zsh-reload zsh-syntax-highlighting)
