...
plugins=(absolute autojump battery brew brew-cask colored-man colorize copydir cp docker docker-machine encode64 extract git-pickaxe go go_env rbenv-installer jsontools osx pry rake rake-fast rbenv redis-cli rsync ruby-functions sbcl sshtunnel sublime thor urltools vpncloud vundle zsh-reload zsh-syntax-highlighting)
