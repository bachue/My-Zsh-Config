...
plugins=(absolute autojump battery brew brew-cask bundler colored-man colorize copydir cp docker dnsmasq encode64 extract gem git git-pickaxe go go_env install-linux-manpages jsontools load-rbenv load-rvm mongodb mydocker osx postgres pry rails rake rake-fast rbenv redis redis-cli rsync ruby ruby-functions sbcl sublime subla thor urltools vundle zsh-syntax-highlighting)
